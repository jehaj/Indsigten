...
def main():
    ...
    parser.add_argument("--reindex", action="store_true", help="Gennemtving genindeksering af alle filer")
    ...
    try:
        ...
        # 3. Indexing
        index_files(args.dirs, engine, processor, cache_base, force_reindex=args.reindex)
